...
class Enemy(Character):
    def __init__(self, health, attack, element):
        class_name = self.__class__.__name__
        super().__init__(class_name, health, attack, element)

#Define enemy Pokemon - Inherits from Enemy
class Rattatta(Enemy):
    def __init__(self):
        super().__init__(50, 35, NORMAL)

class Poliwhirl(Enemy):
    def __init__(self):
        super().__init__(65, 20, WATER)

class Rapidash(Enemy):
    def __init__(self):
        super().__init__(65, 20, FIRE)

class Victoreebel(Enemy):
    def __init__(self):
        super().__init__(65, 20, GRASS)